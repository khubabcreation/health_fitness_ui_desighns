...
class Understand_your_profile extends StatefulWidget {
  const Understand_your_profile({Key? key}) : super(key: key);

  @override
  State<Understand_your_profile> createState() =>
      _Understand_your_profileState();
}

class _Understand_your_profileState extends State<Understand_your_profile> {
   bool check = false;
  @override
