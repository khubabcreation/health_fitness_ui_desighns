...
class Openion_on_SelfControl extends StatefulWidget {
  const Openion_on_SelfControl({Key? key}) : super(key: key);

  @override
  State<Openion_on_SelfControl> createState() => _Openion_on_SelfControlState();
}

class _Openion_on_SelfControlState extends State<Openion_on_SelfControl> {
  @override
                        ...
                        children: [
                          FittedBox(
                            child: Padding(
                              ...
                              child: Text(
                                "I am mostly preoccupied with foo\nall the day",
