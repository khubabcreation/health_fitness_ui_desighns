...
class openion_impact_boredom extends StatefulWidget {
  const openion_impact_boredom({Key? key}) : super(key: key);

  @override
  State<openion_impact_boredom> createState() => _openion_impact_boredomState();
}

class _openion_impact_boredomState extends State<openion_impact_boredom> {
  @override
